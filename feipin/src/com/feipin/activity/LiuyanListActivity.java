...
public class LiuyanListActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.liuyan_manage_list);
		...
		liuyanViewList.setAdapter(new Myadapter(LiuyanListActivity.this,
				liuyanList));
	...
	private void InitData() {
		...
		String url = HttpUtil.BASE_URL + "servlet/LiuyanListServlet";
	...
	public void add_liuyan(View v){
		Intent intent  = new Intent(LiuyanListActivity.this, LiuyanActivity.class);
	...
	class Myadapter extends BaseAdapter {
		...
		public View getView(int position, View convertView, ViewGroup parent) {
			View v = LayoutInflater.from(c).inflate(R.layout.liuyan_list_item,
					null);
